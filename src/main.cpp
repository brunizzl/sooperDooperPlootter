...
int main(int argc, char* argv[])
{
	...
	//test::svg_to_bbf("samples/circle02.svg", "samples/bffs/circle02.bbf", width, height);
	//test::svg_to_bbf("samples/arcs01.svg", "samples/bffs/arcs01.bbf", width, height);
	//test::svg_to_bbf("samples/car.svg", "samples/bffs/car.bbf", width, height);
	...
	//test::svg_to_bbf("samples/selmatec.svg", "samples/bffs/selmatec.bbf", width, height);
